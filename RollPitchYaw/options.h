...
#define DATE "2/4/2021"
#if ( GROUND_TEST == 1)
#if (USE_TILT == 1)
#if ( TILT_ANGLE == 15 )
#define REVISION "rev23, ground test, 15 degree tilt"
#elif ( TILT_ANGLE == 10 )
#define REVISION "rev23, ground test, 10 degree tilt"
#endif // TILT_ANGLE
#else
#define REVISION "rev23, ground test, no tilt"
#endif // USE_TILT
#else
#if (USE_TILT == 1)
#if ( TILT_ANGLE == 15 )
#define REVISION "rev23, flight ready, 15 degree tilt"
#elif ( TILT_ANGLE == 10 )
#define REVISION "rev23, flight ready, 10 degree tilt"
#endif // TILT_ANGLE
#else
#define REVISION "rev23, flight ready, no tilt"
#endif // USE_TILT
#endif // GROUND_TEST
#define MAX_TILT_ANGLE ( 7.5 ) // degrees
#define MAX_TILT_RATE ( 150.0 ) // degrees per second
#define MAX_TILT_PULSE_WIDTH ( 250.0 ) // microseconds
#define MAX_SPIN_RATE ( 500.0 ) // degrees per second
#define MAX_SPIN_PULSE_WIDTH ( 250.0 ) // microseconds
#define MAX_ROLL_ANGLE ( 180 ) // degrees
...
#elif ( TILT_ANGLE == 10 )
#define EARTH_TILT_X ( -2326 ) // 10 degree tilt
...
#define EARTH_TILT_Y ( 0 )
#endif // USE_TILT
#define TILT_START ( 4.6 )
#define TILT_STOP  ( 11.6)
